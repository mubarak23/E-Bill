...
use libp2p::core::upgrade::{read_length_prefixed, write_length_prefixed, ProtocolName, Version};
...
pub async fn new(conf: &Config) -> Result<(Client, Receiver<Event>, EventLoop), Box<dyn Error>> {
